...
def test_zero_smooth():
    ...
    sp = csaps.CubicSmoothingSpline(x, y, smooth=0.0)

    assert sp.smooth == pytest.approx(0.0)
...
@pytest.mark.parametrize(
    'x,y,xi,yid',
    [
        ([1.0, 2.0], [3.0, 4.0], [1.0, 1.5, 2.0], [3.0, 3.5, 4.0]),
        ([1.0, 2.0, 3.0], [3.0, 4.0, 5.0], [1.0, 1.5, 2.0, 2.5, 3.0], [3.0, 3.5, 4.0, 4.5, 5.0]),
        (
            [1.0, 2.0, 4.0, 6.0],
            [2.0, 4.0, 5.0, 7.0],
